...
- [Unified Roadmap](00_INDEX/UNIFIED_ROADMAP.md) — Strategic trajectory.
- [Quickstart Guide](00_INDEX/Quickstart.md) — Rapid onboarding for humans and agents.

## 📖 10_THEORY — Foundations of Perception
- [Theory of Anomalous Contrast (ToAC)](10_THEORY/Theory_of_Anomalous_Contrast.md) — The organizing principle.
...
- [Saturation Models](20_PHYSICS/Saturation_Models.md) — Archie, Simandoux, and Indonesia implementation.
...
- [Malay Basin](40_BASINS/Malay_Basin.md) — Primary operational domain.
- [Sarawak Basin](40_BASINS/Sarawak_Basin.md) — Secondary domain and analogies.

## 🛠️ 50_TOOLS — MCP Capability Surface (12 tools)
- [Tool Index](50_TOOLS/Tool_Index.md) — Full catalog of all 12 GEOX MCP tools.
- **Phase A tools:**
  ...
  - geox_feasibility_check, geox_verify_geospatial, geox_calculate_saturation, geox_query_memory
- **Phase B tools:**
  - [geox_select_sw_model](50_TOOLS/geox_select_sw_model.md) — SW model admissibility from log QC flags.
...
- [Constitutional Floors](70_GOVERNANCE/Floor_Enforcement_Log.md) — F1-F13 verification status.
...
- [Seismic Viewer Spec](80_INTEGRATION/Seismic_Viewer_Spec.md) — Microfrontend implementation guide.

## 🔍 90_AUDITS — Historical Transaction Log
- [999_SEAL](90_AUDITS/999_SEAL.md) — Current state of the forge.
- [Phase A Milestone](90_AUDITS/999_SEAL_PHASE_A.md) — Logic & Core Tools.
- [Phase B Milestone](90_AUDITS/999_SEAL_PHASE_B_PHYSICS.md) — Physics & Visuals.
- [Refactor Step 1 Summary](90_AUDITS/REFACTOR_STEP1_SUMMARY.md) — Core extraction audit.
