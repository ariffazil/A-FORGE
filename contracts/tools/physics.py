...
def register_physics_tools(mcp: FastMCP, profile: str = "full"):
    ...
    @mcp.tool(name="geox.physics.judge_verdict")
    ...
    @mcp.tool(name="geox.physics.validate_operation")
    ...
    @mcp.tool(name="geox.physics.audit_hold_breach")
    ...
    @mcp.tool(name="geox.physics.verify_physics")
    ...
    @mcp.tool(name="geox.physics.compute_stoiip")
    ...
    @mcp.tool(name="geox.physics.fetch_authoritative_state")
    ...
    try:
        ...
        @mcp.tool(name="geox.physics.acp_register")
        ...
        @mcp.tool(name="geox.physics.acp_submit")
        ...
        @mcp.tool(name="geox.physics.acp_check_convergence")
        ...
        @mcp.tool(name="geox.physics.acp_grant_seal")
        ...
        @mcp.tool(name="geox.physics.acp_status")
