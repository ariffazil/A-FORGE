...
def register_earth3d_tools(mcp: FastMCP, profile: str = "full"):
    ...
    @mcp.tool(name="geox.earth3d.load_volume")
    ...
    @mcp.tool(name="geox.earth3d.interpret_horizons")
    ...
    @mcp.tool(name="geox.earth3d.model_geometries")
    ...
    @mcp.tool(name="geox.earth3d.verify_structural_integrity")
