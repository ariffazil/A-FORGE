...
def register_well_tools(mcp: FastMCP, profile: str = "full"):
    ...
    @mcp.tool(name="geox.well.load_bundle")
    ...
    @mcp.tool(name="geox.well.qc_logs")
    ...
    @mcp.tool(name="geox.well.validate_cutoffs")
    ...
    @mcp.tool(name="geox.well.select_sw_model")
    ...
    @mcp.tool(name="geox.well.compute_petrophysics")
    ...
    @mcp.tool(name="geox.well.verify_petrophysics")
