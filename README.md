...
last_verified: 2026-07-17T23:38Z
live_commit: 27fbfb8
sense_port: 7071
mcp_port: 7072
mcp_tools_live: 102
...
MCP: **102 tools** live on `:7072` (`a-forge-mcp.service`); **98 total** across stateless + session-bound. Public door: `mcp.arif-fazil.com`. A2A: routing mesh via AAA cockpit.
