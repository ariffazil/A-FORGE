...
# ═══════════════════════════════════════════════════════════════════════════════
# GEOX Execution Plane — VPS Server (v2.0.0)
# DITEMPA BUKAN DIBERI: Dimension-First Ontology
#
# This is the EXECUTION PLANE — it performs governed calculations.
# It does not know about transport concerns (FastMCP, HTTP, etc.)
# ═══════════════════════════════════════════════════════════════════════════════
