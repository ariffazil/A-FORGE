...
alias --   Kimi:     moonshot/kimi-k2-0711-preview, moonshot/kimi-k1.5-preview
alias --   MiniMax:  minimax/minimax-text-01
alias --   Custom:   Set OPENAI_API_BASE + OPENAI_API_KEY for any OpenAI-compatible API"'
...
export PATH=/root/.local/bin\:/usr/local/sbin\:/usr/local/bin\:/usr/sbin\:/usr/bin\:/sbin\:/bin\:/usr/games\:/usr/local/games\:/snap/bin
